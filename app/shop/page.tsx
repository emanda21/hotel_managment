...
function getCatMeta(cat: string) {
  return CATEGORY_META[cat] ?? { icon: '✦', color: '#C5A880', glow: 'rgba(197,168,128,0.2)' }
}
      ...
      <footer className="shop-footer">
        <div className="shop-footer-inner">
          <div className="shop-footer-logo">
            <span style={{ fontSize: 28, fontFamily: 'Lora, Georgia, serif', color: '#C5A880', fontWeight: 700 }}>DARIS</span>
